...
if(togglePassword){
  togglePassword.addEventListener('click', (e) =>{
    e.preventDefault();
    let icon = e.target.firstElementChild ? e.target.firstElementChild : e.target;
    let password = document.querySelector(e.target.firstElementChild ? e.target.dataset.target : e.target.parentElement.dataset.target);
    if(password){
...
var e = {
    ...
    quill: function () {
        ...
        if (e.isVariableDefined(ql)) {
          ...
          editor.on('text-change', function () {
            $("#quill-field").val($('#quilleditor').find('.ql-editor').html());
    ...
    stepper: function () {
        ...
        if (e.isVariableDefined(stp)) {
          ...
          if(document.querySelector('#stepper').getAttribute('data-to')){
            stepper.to(document.querySelector('#stepper').getAttribute('data-to'));
          }
        }
    },
    // END: Stepper
    ...
    videoPlyr: function () {
        ...
        if (e.isVariableDefined(vdp)) {
            ...
            // Send data
            playerYoutube.on("ended", (e) => {
              console.log(playerYoutube)
              const topic = $("#player-youtube").data("current");
              const course = $("#player-youtube").data("course");
              
              if(topic && course){
                const wdata ="topic=" + topic +"&course=" + course +"&rq=next&rtype=html";
                processHttpRequests("controllers/watch-course.php", wdata, "json").then(function (result) {
                  if (typeof result == "object" && result.success) {
                      result.success.url ? window.location.replace(result.success.url) : null;
            ...
            // Send data
            playerHtmlvideo.on("ended", (e) => {
              console.log(playerHtmlvideo)
              const topic = $("#player").data("current");
              const course = $("#player").data("course");
